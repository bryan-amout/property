...
import com.example.propertyplus.ui.theme.black
import com.example.propertyplus.ui.theme.gold
import com.example.propertyplus.ui.theme.newgreen
import com.example.propertyplus.ui.theme.red
import com.example.propertyplus.ui.theme.screens.propertyscreen.bottomNavItems
                    ...
                    Row {
                        ...
                        Card(){
                            Box (modifier = Modifier
                                ...
                                Icon(imageVector = Icons.Default.Favorite, contentDescription = "Favourite", modifier = Modifier.align(
                                    Alignment.TopStart).padding(10.dp), tint = red)
                        ...
                        Column (modifier = Modifier.padding(start = 20.dp)) {
                            ...
                            Text( text = "The best property" )
                            Row {
                                Icon(imageVector = Icons.Default.Star, contentDescription =  "Star", tint = gold, modifier = Modifier.size(20.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription =  "Star", tint = gold, modifier = Modifier.size(20.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription =  "Star", tint = gold, modifier = Modifier.size(20.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription =  "Star", tint = gold, modifier = Modifier.size(20.dp))
                                Icon(imageVector = Icons.Default.Star, contentDescription =  "Star", tint = gold, modifier = Modifier.size(20.dp))
                            ...
                            Button(onClick = { /*TODO*/ },  colors = ButtonDefaults.buttonColors(newgreen),
